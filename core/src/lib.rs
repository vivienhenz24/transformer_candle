...
pub use architectures::adaptive_depth::{
    AdaptiveDepthConfig, AdaptiveDepthController, DepthDecision, TokenDepthUsage,
};
...
pub use attention::cascade_attention::{
...
pub mod prelude {
    pub use crate::architectures::adaptive_depth::{
        AdaptiveDepthConfig, AdaptiveDepthController, DepthDecision, TokenDepthUsage,
    };
    pub use crate::architectures::cascade::{
        CascadeBlock, CascadeTransformer, CascadeTransformerBuilder, CascadeTransformerConfig,
    };
    ...
    pub use crate::attention::cascade_attention::{
        CascadeAttentionComposer, CascadeAttentionConfig, CrossLayerState,
    };
